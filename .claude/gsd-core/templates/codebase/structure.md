...
- Usage: Reference from command with `@/home/thetzinsoe/projects/ServiceCity/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /home/thetzinsoe/projects/ServiceCity/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/thetzinsoe/projects/ServiceCity/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
