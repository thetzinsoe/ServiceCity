...
- **Global scope**: `/home/thetzinsoe/projects/ServiceCity/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/thetzinsoe/projects/ServiceCity/.claude/notes/`)
...
2. Glob `/home/thetzinsoe/projects/ServiceCity/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/thetzinsoe/projects/ServiceCity/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/thetzinsoe/projects/ServiceCity/.claude/notes/` — works in any directory
