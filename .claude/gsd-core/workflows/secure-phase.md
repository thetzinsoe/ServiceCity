...
```
Agent(
  prompt="Read /home/thetzinsoe/projects/ServiceCity/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/thetzinsoe/projects/ServiceCity/.claude/gsd-core/templates/SECURITY.md`
