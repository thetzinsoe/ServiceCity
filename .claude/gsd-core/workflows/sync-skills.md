...
INSTALL_JS_GLOBAL="/home/thetzinsoe/projects/ServiceCity/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/thetzinsoe/projects/ServiceCity/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
