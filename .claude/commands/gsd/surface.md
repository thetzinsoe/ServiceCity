...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/thetzinsoe/projects/ServiceCity/.claude/.gsd-surface.json`
(sibling to `/home/thetzinsoe/projects/ServiceCity/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/thetzinsoe/projects/ServiceCity/.claude/skills/gsd-*/`.
...
(`/home/thetzinsoe/projects/ServiceCity/.claude`), NOT the skills sub-directory (`/home/thetzinsoe/projects/ServiceCity/.claude/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `/home/thetzinsoe/projects/ServiceCity/.claude` as `configDir`. The skill dirs themselves live at
`/home/thetzinsoe/projects/ServiceCity/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# Claude Code — global install
RUNTIME_CONFIG_DIR="${CLAUDE_CONFIG_DIR:-/home/thetzinsoe/projects/ServiceCity/.claude}"
SCOPE="global"
...
(i.e. `/home/thetzinsoe/projects/ServiceCity/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/thetzinsoe/projects/ServiceCity/.claude/.gsd-surface.json`
Install profile marker: `/home/thetzinsoe/projects/ServiceCity/.claude/.gsd-profile`
Skill dirs: `/home/thetzinsoe/projects/ServiceCity/.claude/skills/gsd-*/`
Engine module: `/home/thetzinsoe/projects/ServiceCity/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/thetzinsoe/projects/ServiceCity/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
