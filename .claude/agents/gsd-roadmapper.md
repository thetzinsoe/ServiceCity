...
Reference full template: `/home/thetzinsoe/projects/ServiceCity/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/thetzinsoe/projects/ServiceCity/.claude/gsd-core/templates/state.md`.
