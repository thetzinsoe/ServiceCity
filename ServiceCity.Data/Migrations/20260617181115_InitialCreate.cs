    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "AC repair and troubleshooting", "Repair", 1 },
                    { 2, "Regular AC maintenance and cleaning", "Maintenance", 2 },
                    { 3, "New AC unit installation", "Installation", 3 },
                    { 4, "Refrigerant gas refill service", "Gas Refill", 4 }
                });
